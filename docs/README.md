...
> @hexlet/fs@0.4.0 documentation /home/stas/Work/hexlet/hexlet-components/js-fs documentation "build" "src/index.js" "-f" "md"
...
Copy file fs.copySync('/etc/hosts', '/etc/nginx'); fs.readdirSync('/etc/nginx'); // [ 'conf.d', 'hosts' ]
